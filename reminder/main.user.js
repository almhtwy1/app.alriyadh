// ==UserScript==
// @name         أداة التذكير للمعاملات (متعددة الصفوف - بالأيام)
// @namespace    http://tampermonkey.net/
// @version      3.0
// @description  إضافة زر تذكير لحفظ بيانات الصفوف المحددة والتذكير بها بعد عدد أيام يتم تحديدها من قبل المستخدم، مع إمكانية تأجيل التذكير بناءً على الرقم المدخل في مربع بجانب زر التأجيل وعدم حذف التذكير إلا عند اتخاذ إجراء من المستخدم. يتيح النقر المزدوج على الصف لفتح المعاملة دون تعطيل، مع إضافة عمود حذف لكل صف في نافذة التذكير يظهر كـ "×" بدون خلفية دائرية.
